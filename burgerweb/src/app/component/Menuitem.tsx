        ...
        <div className="relative text-center p-10">
            ...
            <section id="Projects" className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3  md:grid-cols-2 justify-items-center gap-y-20 gap-x-14 mt-10 mb-5 ">
             {Array.from({length:6}).map((_,index)=>(
                <div   className="w-70 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl z-10 relative" key={index}>

                    <a href="">
                        <Image  className="h-80 w-72  object-cover rounded-t-xl" src={productImages[index]} alt={`product ${index+1}`} />
