...
const Menu = () => {
  ...
  return (
    <div className="relative min-h-screen py-6">
      <div
        className="absolute inset-0 bg-cover bg-center opacity-3 animate-background"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10">
        <div className="max-w-6xl mx-auto text-center mb-8">
          ...
          <p className="text-xl text-white">
            Explore our mouthwatering selection of burgers to order now
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto mt-8">
          <button
            onClick={toggleCart}
            className="bg-blue-600 text-white py-3 px-6 text-lg rounded-lg shadow-md hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-110"
          >
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-96">
              ...
              <div className="mt-6 flex justify-between">
                <button
                  ...
                  className="bg-slate-600 text-white py-2 px-2 rounded-lg text-lg shadow-md hover:bg-slate-600 transition duration-300"
                >
                  Close
                </button>

                <button
                  onClick={() => alert('Order confirmed. Will be delivered in 2 days!')}
                  className="bg-green-600 text-white py-2 px-2 rounded-lg text-lg shadow-md hover:bg-green-600 transition duration-300"
                >
                  Confirm Order
                </button>
              </div>
